  ...
  var stats = [
    {
      ...
      data: require('../stats/01')(data.income['2017'], 6)
    }, {
      title: 'Среден месечен разход по месеци, групиран по разход',
      data: require('../stats/02')(data.spend, ['2011', '2017'])
    }, {
      title: 'Среден месечен разход, групиран по месеци',
      data: require('../stats/03')(data.spend, ['2011', '2017'])
    }, {
      title: 'Среден месечен разход до сега',
      data: require('../stats/04')(data.spend, 5, 6)
    }
  ]
                ...
                m('.card-body',
                  ...
                  m('blockquote',
                    m('ul',
                      ...
                      m('li', 'изобразени са единствено разходи с минимален сумарен разход от 150лв')
                    )
                  )
                )
              )
            ...
            m('.column',
              m('.card',
                ...
                m('.card-body',
                  ...
                  m('blockquote',
                    m('ul',
                      m('li', 'стойноста включва всички месеце/години до сега')
                    )
                  )
                )
              )
